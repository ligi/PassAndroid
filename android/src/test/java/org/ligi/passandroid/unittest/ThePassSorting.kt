...
class ThePassSorting {
    ...
    private val pass4 = PassImpl("ID3")
    ...
    fun init() {
        ...
        passList = mutableListOf(pass1, pass2, pass3, pass4)
    }
    ...
    fun testDESC() {
        ...
        assertThat(passList).containsExactly(pass4, pass1, pass3, pass2)
    }
    ...
    fun testASC() {
        ...
        assertThat(passList).containsExactly(pass2, pass3, pass1, pass4)
    }
    ...
    fun testDIFF() {
        ...
        assertThat(passList).containsExactly(pass3, pass2, pass1, pass4)
    }
    ...
    fun testTYPE() {
        ...
        assertThat(passList).containsExactly(pass3, pass1, pass4, pass2)
    }
